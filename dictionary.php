...
define("EXTEND_STEP", 1000);       // Шаг увеличения размерности таблицы
define("CLEANUP_THRESHOLD", 0.05); // % от удаленных в таблице, после которого следует сделать чистку
 ...
 *
 * @param $dict    Ассоциативный массив.
 * @param $key     Ключ, по которому мы хотим получить значение из $dict.
 * @param $default Значение по умолчанию, которое функция вернет, если не найдет $key в $dict.
 *
 * @throws InvalidArgumentException если были переданы неверные значения в $dict и $key.
 *
 * @return Значение, хранимое по ключу $key в $dict или $default.
 */
 ...
 *
 * @param $dict  Ассоциативный массив.
 * @param $key   Ключ, по которому запишем данные из $value.
 * @param $value Значение, сохраняемое по ключу $key.
