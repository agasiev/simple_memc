...
if ($_POST["executed"] == 1) {
    ...
    $request = nl2br(htmlspecialchars($request));
...
<body>
    ...
    <div>
        <form method="post" action="index.php">
            ...
            <input type="text" name="param" id="param" size="50" placeholder="key_name" value="<?= $param ?>"/>&nbsp;
